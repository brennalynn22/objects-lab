...
function totalPopulation(homeValues) {
const {utah, california, texas, arizona} =homeValues
...
let Giles=new Cat ('Giles',7,'peach');
let Edgar=new Cat ('Edgar', 17, 'grey tabby' );

console.log(Giles)
console.log(Edgar)
for (const key in Edgar){
  console.log(Edgar[key])
}
//////////////////////////// PROBLEM 13 ////////////////////////////
/*
...
let harry = new Wizard('Harry', 15,'Expecto Patronum')
...
//Code Here
let apple = new Phone('iPhone', 'se', 128, 'green', 249)
let google = new Phone('Pixel', '5a', 256, 'black', 499)
let samsung = new Phone('Galaxy', 'newest', 256,'silver', 1200) 

samsung.changePrice(1100)
console.log(samsung)
/* 
...
//Code Here
const murphy = new Vehicle(5, 'teal', 100000)
murphy.move(1400)
...
class Motorcycle extends Vehicle{
  ...
  //   this.mileage += miles
  // console.log(this.mileage)
  // } not needed since its in the parent class?
}
/*
  Create a Motorcycle using your new class and save it to a variable called myFirstMotorcycle
*/
const myFirstMotorcycle = new Motorcycle(1, 'black', 2597, 'harley',true) 
...
//Code Here
const myFirstBoat = new boat(10,'blue',293, 'Orion','sailboat', false)
/*
